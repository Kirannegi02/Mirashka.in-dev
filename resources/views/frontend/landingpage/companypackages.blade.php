                  ...
                  <div class="col-xl-7 col-lg-6 col-md-12">
                     <div class="title_all_box style_one dark_color">
                        <div class="title_sections">
                           ...
                           We Elevate Companies From Competitors to Market Leaders                           </h1>
                           <!-- Sub-headline -->
                           <p class="gold textbg">
                             Premium PR for Startups, Scale-Ups & High-Growth Brands — crafted in India, trusted across the world.
                           </p>
                           <hr class="border-light w-25 my-4 opacity-75">
                           <!-- Value Statement -->
                           <p class="mb-4">
In a world racing toward tomorrow, we bring back the timeless art of reputation, influence, and narrative power—elevated through modern strategy, global media, and AI-driven precision for companies ready to lead, not follow.                           </p>
                           <div class="title_sections">
      ...
      <div class="row gutter_25px">
         ...
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="counter-block style_three count-box counted">
               <div class="icon_box icon_yes ">
                  <div class="icon">
                     <img src="assets/frontend/img/icon2.svg">
                  </div>
               </div>
               <div class="content_box">
                  <h6>For Companies</h6>
         ...
         <div class="col-lg-12">
            <div class="title_all_box style_one text-center dark_color">
               <div class="title_sections">
                  ...
                  <div class="title">Building Long-Term Brand Authority</div>
               </div>
               <div class="pd_bottom_40"></div>
            </div>
         </div>
      ...
      <div class="row">
         ...
         <div class="col-xl-3 col-lg-6 mb-5 mb-lg-5 mb-xl-0">
            <div class="simple_image_boxes height_360px parallax_cover">
               <img src="{{ asset('assets/frontend/img/faq1.jpg') }}" class="simp_img cover-parallax" alt="Company PR">
            </div>
            <div class="mr_bottom_25"></div>
            <div class="progress_bar">
               <h2>Brand Credibility <span>95%</span></h2>
               <div class="bar">
         ...
         <div class="col-xl-3 col-lg-6 mb-5 mb-lg-5 mb-xl-0">
            <div class="simple_image_boxes height_360px parallax_cover">
               <img src="{{ asset('assets/frontend/img/faq2.jpg') }}" class="simp_img cover-parallax" alt="Media Visibility">
            </div>
            <div class="mr_bottom_25"></div>
            <div class="progress_bar">
               <h2>Market Visibility <span>120+</span></h2>
               <div class="bar">
                  ...
                  <div class="accordion">
                     <dl>
                        ...
                        <dt class="faq_header active">
                           <span class="icon-play"></span> Why is company-level PR essential for growth-stage brands?
                        </dt>
                        <dd class="accordion-content hide" style="display:block;">
                           <p>
                              Company-level PR builds the foundation of trust that drives investor confidence, shortens sales cycles, and positions your brand as a credible market leader—not just a visible one.
                           </p>
                        </dd>

                        <!-- FAQ 2 -->
                        <dt class="faq_header">
                           <span class="icon-play"></span> How is your approach different from traditional PR agencies?
                        </dt>
                        <dd class="accordion-content hide">
                           <p>
                              We focus on narrative architecture and long-term reputation engineering rather than one-off media placements—ensuring consistent visibility that compounds over time.
                           </p>
                        </dd>

                        <!-- FAQ 3 -->
                        <dt class="faq_header">
                           <span class="icon-play"></span> Do you focus on campaigns or ongoing brand positioning?
                        </dt>
                        <dd class="accordion-content hide">
                           <p>
                              Our approach prioritizes sustained, multi-market positioning over short-term campaigns—helping brands build authority that lasts beyond temporary spikes.
                           </p>
                        </dd>

                        <!-- FAQ 4 -->
                        <dt class="faq_header">
                           <span class="icon-play"></span> What outcomes can we expect from company PR packages?
                        </dt>
                        <dd class="accordion-content hide">
                           <p>
                              Clients typically experience stronger brand perception, increased media credibility, improved stakeholder trust, and a more structured growth narrative across markets.
                           </p>
                        </dd>
