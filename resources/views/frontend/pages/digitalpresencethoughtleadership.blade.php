...
@section('content')
   ...
   <!----banner---->
     <section class="banner-section bg_op_1 position-relative overflow-hidden" style="background-image: url('{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/banner-1.webp') }}');
               ...
               <div class="col-xl-7 col-lg-6 col-md-12">
                  <div class="title_all_box style_one dark_color">
                     <div class="title_sections">
                        <div class="custom-badge">DIGITAL PRESENCE & THOUGHT LEADERSHIP</div>
                        <h2 class="title_big text-white">
                           Build a Digital Presence That Reflects Leadership, Not Just Activity
                        </h2>
               ...
               <div class="col-lg-12">
                  <div class="left_content">
                     <div class="main_content">
                        ...
                        <p class="text-black">
                           In a high-visibility market, leaders are often evaluated online before they are ever met
                           offline. This category is built to help leadership teams create a digital identity that reflects
                           seriousness, credibility, and a clear point of view.
                        </p>
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              ...
                              <img
                                 src="{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/what/image-1.webp') }}">
                           </div>
                           <div class="content">

                              <h2 class="title_service"><a href="#">LinkedIn Authority Building</a></h2>
                              <p class="text-white">Build a strong and credible leadership presence on LinkedIn that drives
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img
                                 src="{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/what/image-2.webp') }}">
                           </div>
                           <div class="content">

                              <h2 class="title_service"><a href="#">Leadership Media Training</a></h2>
                              <p class="text-white">Prepare leaders to communicate with clarity, confidence, and authority
                                 across media platforms.</p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           ...
                           <div class="content">
                              ...
                              <h2 class="title_service"><a href="#">Influence Coaching</a></h2>
                              <p class="text-white">Strategic coaching to help leaders shape perception, presence, and
                                 communication impact.</p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           ...
                           <div class="content">
                              ...
                              <h2 class="title_service"><a href="#">Executive Thought Leadership Strategy</a></h2>
                              <p class="text-white">Structured content strategies that position leaders as credible voices
                                 in their domain.</p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           ...
                           <div class="content">
                              ...
                              <h2 class="title_service"><a href="#">Content Positioning for Public Leaders</a></h2>
                              <p class="text-white">Create content that reflects clarity, credibility, and a strong
            ...
            <div class="col-xl-6 col-lg-10 col-md-12">
               <div class="image_boxes style_five">
                  <div class="image_box one">
                     <img src="{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/what/image-1.webp') }}"
                        class="img-fluid" alt="img">
                  </div>
                  <div class="image_box two">
                     <img src="{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/what/image-2.webp') }}"
                        class="img-fluid two" alt="img">
                  </div>
               </div>
            </div>
               ...
               <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <div class="service_box style_five dark_color mr_top_minus_160">
                     <div class="service_content">
                        <div class="image_box">
                           <img
                              src="{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/outcomes/a-sharper-leadership-profile.webp') }}"
                              class="img-fluid">
                        </div>
               ...
               <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <div class="service_box style_five dark_color mr_top_minus_160 mr_md_top_zero">
                     <div class="service_content">
                        <div class="image_box">
                           <img
                              src="{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/outcomes/stronger-market-credibility.webp') }}"
                              class="img-fluid">
                        </div>
                        <div class="content_inner">
               ...
               <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <div class="service_box style_five dark_color mr_top_minus_160 mr_md_top_zero">
                     <div class="service_content">
                        <div class="image_box">
                           <img
                              src="{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/outcomes/better-recall-&-market-positioning.webp') }}"
                              class="img-fluid">
                        </div>
                        <div class="content_inner">
            ...
            <div class="col-xl-6 col-lg-12 mb-5 mb-lg-5 mb-xl-0">
               <div class="creote-image-box image-box-overlap">
                  <div class="image_boxes style_eight">
                     <img src="{{ asset('assets/frontend/img/whatwedointernalpages/digital-presence/why.webp') }}"
                        ...
                        <ul class="list-inline">
                           ...
                           <li class="list_items pd_bottom_10">
                              <small class="d-flex align-items-center">
                                 <span class="icon_bx"><i class="icon-checked"></i></span>
                                 <a class="nav_link" href="#">
                                    We align your digital identity with your market ambition, media visibility, and
                           ...
                           <li class="list_items pd_bottom_10">
                              <small class="d-flex align-items-center">
                                 <span class="icon_bx"><i class="icon-checked"></i></span>
                                 <a class="nav_link" href="#">
                                    We focus on credibility, clarity, and long-term authority—not short-term visibility
                                    spikes
                                 </a>
                              </small>
                           </li>
                           ...
                           <li class="list_items pd_bottom_10">
                              <small class="d-flex align-items-center">
                                 <span class="icon_bx"><i class="icon-checked"></i></span>
                                 <a class="nav_link" href="#">
                                    We combine content, positioning, and media thinking into one cohesive leadership
                                    presence
                                 </a>
                              </small>
                           </li>
                           ...
                           <li class="list_items pd_bottom_10">
                              <small class="d-flex align-items-center">
                                 <span class="icon_bx"><i class="icon-checked"></i></span>
                                 <a class="nav_link" href="#">
                                    We help you look not louder, but stronger in your category
                                 </a>
                              </small>
                           </li>
