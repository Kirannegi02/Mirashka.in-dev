...
<div class="page_header_default style_one">
    <div class="parallax_cover">
        <img src="{{ asset('assets/frontend/images/page-header-default.jpg') }}" alt="bg_image" class="cover-parallax">
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner_title_inner">
                        <div class="title_page">Terms & Conditions</div>
                    </div>
                </div>
            </div>
        </div>
...
<p>
Legal Name: EOM CONSULTING LLP<br>
Trade Name: EOM CONSULTING LLP<br>
GST Number: 09AAMFE5079K1ZS<br>
Registered Address: B9-1702, Gardenia Glory, Sector 46, Noida, Uttar Pradesh – 201303
</p>

<h5 class="fw-semibold mt-4">Services</h5>
...
<li>✔ You will not attempt unauthorized access.</li>
<li>✔ You will comply with all applicable Indian laws.</li>
</ul>
...
<h5 class="fw-semibold mt-4">Jurisdiction</h5>
<p>These terms are governed by Indian law. Courts of Uttar Pradesh shall have exclusive jurisdiction.</p>
