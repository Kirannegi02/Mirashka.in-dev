...
<style>
   ...
   body.page-home .way-section {
      ...
      --mh-h2: clamp(1.75rem, 3vw, 2.25rem); /* 28–36px — section heading */
   ...
   .mirashka-home .before_title,
   .mirashka-home .home-why-mirashka__eyebrow,
   .mirashka-home .home-growth-reality__eyebrow,
   .mirashka-home .home-growth-reality__timeline-step,
   .mirashka-home .home-hr-os__eyebrow,
   .mirashka-home .home-hr-os__hub strong,
   .mirashka-home [class*="__eyebrow"],
   .mirashka-home [class*="__label"]:not([class*="__card"]):not(label) {
      font-size: var(--mh-eyebrow) !important;
   ...
   .mirashka-home .home-growth-reality__pains-title,
