         ...
         <div class="row">
            <div class="col-xl-6 col-lg-12 col-md-12 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
               <div class="image_boxes style_one">
                  <div class="image one">
                     <img src="{{ asset('assets/frontend/img/who-we-are.webp') }}" class="img-fluid" alt="image" />
                  </div>
                  <div class="image two">
                     <img src="{{ asset('assets/frontend/img/video.webp') }}" class="img-fluid" alt="image" />
                  ...
                  <div class="swiper-wrapper">
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              ...
                              <img src="{{ asset('assets/frontend/img/executive.png') }}" alt="Executive Influence">
                           </div>
                           <div class="content">
                              <div class="icon_box"><span><img src="{{ asset('assets/frontend/img/Executive.svg') }}"></span></div>
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img src="{{ asset('assets/frontend/img/cxo.png') }}" alt="CXO Digital Presence">
                           </div>
                           <div class="content">
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img src="{{ asset('assets/frontend/img/voice.png') }}" alt="Podcast Development">
                           </div>
                           <div class="content">
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img src="{{ asset('assets/frontend/img/reputation.png') }}" alt="Awards Positioning">
                           </div>
                           <div class="content">
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img src="{{ asset('assets/frontend/img/presence.png') }}" alt="Speaking Engagements">
                           </div>
                           <div class="content">
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img src="{{ asset('assets/frontend/img/reputation-risk.png') }}" alt="Crisis Preparedness">
                           </div>
                           <div class="content">
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img src="{{ asset('assets/frontend/img/capital.png') }}" alt="Capital Markets">
                           </div>
                           <div class="content">
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img src="{{ asset('assets/frontend/img/leadership.png') }}" alt="Media Training">
                           </div>
                           <div class="content">
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              <div class="overlay"></div>
                              <img src="{{ asset('assets/frontend/img/regional.png') }}" alt="Regional Impact">
                           </div>
                           <div class="content">
         ...
         <div class="row">
               ...
               <div class="choose_box type_two">
                  <div class="icon_box">
                     <div class="icon_image">
                        <img src="{{ asset('assets/frontend/img/Enterprise.svg') }}" class="img-fluid svg_image" alt="icon">
                     </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
               <div class="choose_box type_two">
                  <div class="icon_box">
                     <div class="icon_image">
                        <img src="{{ asset('assets/frontend/img/AI.svg') }}" class="img-fluid svg_image" alt="icon">
                     </div>
                     <span class="icon_bg_rotate"></span>
                  </div>
                  <div class="content_box">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
               <div class="choose_box type_two">
                  <div class="icon_box">
                     <div class="icon_image">
                        <img src="{{ asset('assets/frontend/img/Health.svg') }}" class="img-fluid svg_image" alt="icon">
                     </div>
                     <span class="icon_bg_rotate"></span>
                  </div>
                  <div class="content_box">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
               <div class="choose_box type_two">
                  <div class="icon_box">
                     <div class="icon_image">
                        <img src="{{ asset('assets/frontend/img/BFSI.svg') }}" class="img-fluid svg_image" alt="icon">
                     </div>
                     <span class="icon_bg_rotate"></span>
                  </div>
                  <div class="content_box">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
               <div class="choose_box type_two">
                  <div class="icon_box">
                     <div class="icon_image">
                        <img src="{{ asset('assets/frontend/img/Infrastructure.svg') }}" class="img-fluid svg_image" alt="icon">
                     </div>
                     <span class="icon_bg_rotate"></span>
                  </div>
                  <div class="content_box">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
               <div class="choose_box type_two">
                  <div class="icon_box">
                     <div class="icon_image">
                        <img src="{{ asset('assets/frontend/img/Luxury.svg') }}" class="img-fluid svg_image" alt="icon">
                     </div>
                     <span class="icon_bg_rotate"></span>
                  </div>
                  <div class="content_box">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
               <div class="choose_box type_two">
                  <div class="icon_box">
                     <div class="icon_image">
                        <img src="{{ asset('assets/frontend/img/International.svg') }}" class="img-fluid svg_image" alt="icon">
                     </div>
                     <span class="icon_bg_rotate"></span>
                  </div>
                  <div class="content_box">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
               <div class="choose_box type_two">
                  <div class="icon_box">
                     <div class="icon_image">
                        <img src="{{ asset('assets/frontend/img/Public.svg') }}" class="img-fluid svg_image" alt="icon">
                     </div>
                     <span class="icon_bg_rotate"></span>
                  </div>
                  <div class="content_box">
