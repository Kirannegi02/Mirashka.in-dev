...
<section class="expertise">
   <div class="area_of_expertise">
      <div class="simpleParallax">
         <img id="expertise-image" src="{{ asset('assets/frontend/img/page2/hw_banner.jpg') }}" class="cover-parallax" alt="Enterprise Tech & SaaS">
      </div>
...
Building Trust, Authority, and Public Confidence for Health & Wellness Brands
                        </h2>
                        <p id="expertise-desc">
         ...
         <div class="col-xl-6 col-lg-12 mb-5 mb-lg-5 mb-xl-0">
            <div class="image_boxes style_four">
               <div class="image_box one">
                  <img src="{{ asset('assets/frontend/img/page2/hw_wws_1.jpg') }}" class="img-fluid" alt="Enterprise Tech">
               </div>
               <div class="image_box">
                  <div class="row">
                     <div class="col-lg-6 col-md-12 ps-0 pe-0 pe-lg-3 mb-4 mb-lg-0">
                        <div class="imgs">
                           <img src="{{ asset('assets/frontend/img/page2/hw_wws_2.jpg') }}" class="img-fluid one_img" alt="SaaS">
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-12 ps-0 ps-lg-3 pe-0">
                        <div class="imgs">
                           <img src="{{ asset('assets/frontend/img/page2/hw_wws_3.jpg') }}" class="img-fluid one_img" alt="B2B Tech">
                        </div>
                     </div>
                  </div>
               </div>
...
In Health & Wellness, Trust Is the First Reputation Asset
                     </h2>
                     <!-- BODY -->
                     <p>
                      
Health and wellness brands operate in one of the most trust-sensitive communication environments. Audiences do not just ask whether a brand is visible. They ask whether it is credible, responsible, expert-led, and worthy of confidence. We help healthcare, wellness, and human-impact brands build communication that balances authority, empathy, and long-term trust.
      ...
      <div class="row align-items-center">
         ...
         <div class="col-xl-6 col-lg-12 mb-lg-5 mb-xl-0">
            <div class="image_boxes style_six">
               <div class="image_box">
                  <img src="{{ asset('assets/frontend/img/page2/hw_e.jpg') }}" 
                     class="img-fluid height_510px object-fit-cover" alt="health wellness">
                  ...
                  <div class="experience">
                     <div class="experience_inner">
                        <h2>Health & Wellness Expertise</h2>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="col-xl-6 col-lg-12">
            <div class="title_all_box style_five dark_color">
               <div class="title_sections five">
                  ...
                  <div class="before_title">Our Edge in Health & Wellness</div>

                  <h2>
                     We Understand the Language of Care, Credibility, and Category Trust
                  </h2>

                  <div class="description_box">
                     <p>
                        Health and wellness communication cannot rely on generic visibility tactics. 
                        The category demands clarity, responsibility, and trust-led positioning across every touchpoint.
                     </p>
                        ...
                        <div class="text_box">
                           <h2>
                              <a href="{{ url('/case-studies') }}">
                                 Built for High-Trust Category Positioning
                              </a>
                           </h2>
                        </div>
                     </div>
                        ...
                        <div class="text_box">
                           <h2>
                              <a href="{{ url('/media-coverage') }}">
                                 Positioned Across Business, Health & Wellness Media
                              </a>
                           </h2>
                        </div>
                     </div>
         ...
         <div class="row">
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="title_all_box style_one light_color">
                  <div class="title_sections">
                     <div class="before_title">
Ready to Build Authority for Your Health & Wellness Brand?
</div>
...
<section class="creote-service-box">
   ...
   <div class="title_all_box style_seven text-center dark_color">
      <div class="title_sections">
         ...
         <div class="title">Specialised Services for Health & Wellness Brands</div>
         <div class="small_text_sub">
            Built to strengthen trust, expert credibility, and long-term category leadership in sensitive environments.
         </div>
      </div>
   </div>
         ...
         <div class="col-xl-4 col-lg-6 col-md-12">
            <div class="service_post style_one">
               ...
               <div class="service_content icon_yes">
                  ...
                  <h2 class="title_service"><a href="#">Brand Trust & Category Storytelling</a></h2>
                  <p class="short_desc">
                     Shape narratives that make your offering feel responsible, credible, and valuable in a high-sensitivity category.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="col-xl-4 col-lg-6 col-md-12">
            <div class="service_post style_one">
               ...
               <div class="service_content icon_yes">
                  ...
                  <h2 class="title_service"><a href="#">Founder, Doctor & Expert Authority Building</a></h2>
                  <p class="short_desc">
                     Position founders, clinicians, and experts as trusted voices across healthcare, wellness, and public-facing conversations.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="col-xl-4 col-lg-6 col-md-12">
            <div class="service_post style_one">
               ...
               <div class="service_content icon_yes">
                  ...
                  <h2 class="title_service"><a href="#">LinkedIn Authority for Health Leaders</a></h2>
                  <p class="short_desc">
                     Strengthen digital presence for founders, doctors, and wellness leaders in credibility-driven environments.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="col-xl-4 col-lg-6 col-md-12">
            <div class="service_post style_one">
               ...
               <div class="service_content icon_yes">
                  ...
                  <p class="short_desc">
                     Secure presence across health summits, wellness forums, institutional events, and expert-led panels.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="col-xl-4 col-lg-6 col-md-12">
            <div class="service_post style_one">
               ...
               <div class="service_content icon_yes">
                  ...
                  <h2 class="title_service"><a href="#">Podcast & Audio IP for Expert-Led Brands</a></h2>
                  <p class="short_desc">
                     Build voice-led content platforms for educators, wellness leaders, and healthcare founders to deepen trust.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="col-xl-4 col-lg-6 col-md-12">
            <div class="service_post style_one">
               ...
               <div class="service_content icon_yes">
                  ...
                  <p class="short_desc">
                     Support narrative control during sensitive moments involving scrutiny, misinformation, and trust-critical public conversations.
                  </p>
               </div>
            </div>
         </div>
