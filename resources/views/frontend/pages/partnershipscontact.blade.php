            ...
            <div class="col-lg-12">
               <div class="breadcrumbs creote">
                  <ul class="breadcrumb m-auto">
                     ...
                     <li class="active">                     Partnerships contact
</li>
                  </ul>
               </div>
            </div>
         ...
         <div class="col-xl-6 col-lg-12">
             <div class="title_all_box style_one dark_color">
                <div class="title_sections left">
                   ...
                   <h2>Build Strategic Alliances</h2>
                   <p>Partner with us to unlock new opportunities, expand your network, and create mutual growth through collaborative initiatives.</p>
                </div>
             </div>
               ...
               <div class="process_box_outer">
                  <div class="icon">
                   ...
                   <div class="content_box">
                      <h2>
                         <a href="#" target="_blank" rel="nofollow">Strategic Alliances</a>
                      </h2>
                      <p>Collaborate with industry leaders to expand reach and create mutual business value.</p>
                   </div>
               </div>
            </div>
            <div class="process_box style_one dark_color">
               <div class="process_box_outer">
                  <div class="icon">
                   ...
                   <div class="content_box">
                      <h2>
                         <a href="#" target="_blank" rel="nofollow">Joint Ventures</a>
                      </h2>
                      <p>Develop co-branded initiatives that leverage complementary strengths and expertise.</p>
                   </div>
               </div>
            </div>
                     ...
                     <div class="service_box style_one dark_color">
                        <div class="service_content">
                           ...
                           <div class="content_inner">
                            <h2>
                                  <a href="#">Media Partnerships</a>
                               </h2>
                               <p>Access exclusive media channels and co-create content with leading publications.</p>
                  ...
                  <div class="col-lg-6 col-md-6">
                     ...
                     <div class="service_box style_one dark_color last">
                        <div class="service_content">
                           ...
                           <div class="content_inner">
                            <h2>
                                  <a href="#">Event Collaborations</a>
                               </h2>
                               <p>Co-host webinars, summits, and networking events with industry peers and influencers.</p>
                              <a href="#" class="read_more">Read more</a>
                           </div>
                        </div>
                     </div>
