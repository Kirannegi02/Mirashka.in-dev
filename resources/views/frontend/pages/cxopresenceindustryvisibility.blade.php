...
@section('content')
  <style type="text/css">
   ...
   <!----banner---->
     <section class="banner-section bg_op_1 position-relative overflow-hidden" style="background-image: linear-gradient(45deg, #ffffff, transparent), url('{{ asset('assets/frontend/img/page/cxo-banner.webp') }}');
            ...
            <div class="col-lg-12">
               <div class="left_content">
                  <div class="main_content">
                     ...
                     <!-- DESCRIPTION -->
                     <p class="text-black">
                        This is not about attending more events. It is about being visible where influence is built.
                        Industry visibility helps leaders become more trusted, more memorable, and more aligned with the conversations
                        that shape their market.
                     </p>
         ...
         <div class="col-lg-8">
            <div class="title_all_box style_one dark_color">
               <div class="title_sections">
                  ...
                  <h2>
                     What We Build Under CXO Presence & Industry Visibility
                  </h2>
                     ...
                     <div class="service_carousel style_one">
                        ...
                        <div class="content">
                           ...
                           <h2 class="title_service">
                              <a href="#">Speaking Engagements & Events</a>
                           </h2>
                           <p class="text-white">
                              Positioning leaders on high-impact stages, panels, and industry speaking opportunities.
                           </p>
                        </div>
                  ...
                  <div class="swiper-slide">
                     <div class="service_carousel style_one">
                        ...
                        <div class="content">
                           ...
                           <h2 class="title_service">
                              <a href="#">Capital Markets Communication</a>
                           </h2>
                           <p class="text-white">
                              Crafting investor-ready narratives that strengthen market confidence and clarity.
                           </p>
                        </div>
                  ...
                  <div class="swiper-slide">
                     <div class="service_carousel style_one">
                        ...
                        <div class="content">
                           ...
                           <h2 class="title_service">
                              <a href="#">Investor Visibility</a>
                           </h2>
                           <p class="text-white">
                              Enhancing leadership presence in investor ecosystems and financial media narratives.
                           </p>
                        </div>
                  ...
                  <div class="swiper-slide">
                     <div class="service_carousel style_one">
                        ...
                        <div class="content">
                           ...
                           <h2 class="title_service">
                              <a href="#">Leadership Positioning in Industry Forums</a>
                           </h2>
                           <p class="text-white">
                              Building authority through curated presence in conferences, panels, and industry bodies.
                           </p>
                        </div>
                  ...
                  <div class="swiper-slide">
                     <div class="service_carousel style_one">
                        ...
                        <div class="content">
                           ...
                           <h2 class="title_service">
                              <a href="#">Stage & Stakeholder Visibility Strategy</a>
                           </h2>
                           <p class="text-white">
                              Aligning leadership visibility with key stakeholders, influence moments, and strategic stages.
                           </p>
                        </div>
         ...
         <div class="col-xl-6 col-lg-12 col-md-12 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
            <div class="title_all_box style_one dark_color">
               <div class="title_sections left">
                  ...
                  <h2 class="title">
                     If Your Leadership Needs to Be Seen in the Right Rooms, This Is the Moment
                  </h2>

                  <p>
                     This category becomes crucial when leaders enter larger industry conversations, prepare for investor attention,
                     expand market footprint, or need to be perceived as more than operational heads and more like category voices.
                  </p>
         ...
         <div class="col-xl-6 col-lg-10 col-md-12">
            <div class="image_boxes style_five">
               <div class="image_box one">
                  <img src="{{ asset('assets/frontend/img/page/iv2.webp') }}" class="img-fluid" alt="img">
               </div>
               <div class="image_box two">
                  <img src="{{ asset('assets/frontend/img/page/iv1.webp') }}" class="img-fluid two" alt="img">
               </div>
            </div>
         </div>
         ...
         <div class="row gutter_30px">
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="description_box color_white text-md-end">
                  <p>
                     Stronger executive visibility. Better industry recall. More credible investor-facing presence.
                     Higher-value networking opportunities. A leadership identity that feels more authoritative,
                     trusted, and aligned with how the market perceives category leaders.
                  </p>
               </div>
            </div>
               ...
               <div class="service_box style_five dark_color mr_top_minus_160">
                  <div class="service_content">
                     ...
                     <div class="content_inner">
                        ...
                        <div class="text_box">
                           <h2><a href="#">Stronger Executive Visibility</a></h2>
                           <p>
                              Build a leadership presence that is consistently visible across key industry and stakeholder touchpoints.
                           </p>
                        </div>
                     </div>
               ...
               <div class="service_box style_five dark_color mr_top_minus_160 mr_md_top_zero">
                  <div class="service_content">
                     ...
                     <div class="content_inner">
                        ...
                        <div class="text_box">
                           <h2><a href="#">Better Industry Recall</a></h2>
                           <p>
                              Ensure your brand and leadership remain memorable in competitive and saturated markets.
                           </p>
                        </div>
                     </div>
               ...
               <div class="service_box style_five dark_color mr_top_minus_160 mr_md_top_zero">
                  <div class="service_content">
                     ...
                     <div class="content_inner">
                        ...
                        <div class="text_box">
                           <h2><a href="#">More Credible Investor Presence</a></h2>
                           <p>
                              Strengthen trust signals that improve investor confidence and stakeholder perception.
                           </p>
                        </div>
                     </div>
         ...
         <div class="col-xl-6 col-lg-12 col-md-12 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
            <div class="title_all_box style_one dark_color">
               <div class="title_sections left">
                  ...
                  <p>
                     We do not build random presence. We build strategic visibility.
                     We understand how a founder or CXO should show up across stages, investor environments,
                     and leadership forums to look credible, sharp, and influential.
                  </p>
               ...
               <div class="block_faq">
                  <div class="accordion">
                     <dl>
                        ...
                        <dt class="faq_header">
                           <span class="icon-play"></span> Is this only for senior CXOs?
                        </dt>
                        <dd class="accordion-content hide">
                           <p>
                              No. While CXOs benefit the most, we also work with founders, senior leaders, and high-growth businesses
                              looking to strengthen authority and visibility.
                           </p>
                        </dd>

                        <dt class="faq_header">
                           <span class="icon-play"></span> Do you help identify platforms as well?
                        </dt>
                        <dd class="accordion-content hide">
                           <p>
                              Yes. We shortlist and recommend the most relevant awards, media platforms, and recognition opportunities
                              based on your industry and positioning.
                           </p>
                        </dd>

                        <dt class="faq_header">
                           <span class="icon-play"></span> Can this align with PR and LinkedIn?
                        </dt>
                        <dd class="accordion-content hide">
                           <p>
                              Absolutely. We integrate recognition strategy with PR narratives and LinkedIn positioning to ensure
                              consistent executive visibility across channels.
                           </p>
                        </dd>

                        <dt class="faq_header">
                           <span class="icon-play"></span> Is this valuable in B2B and niche sectors?
                        </dt>
                        <dd class="accordion-content hide">
                           <p>
                              Yes. In B2B and niche industries, credibility and authority matter even more than mass visibility,
