      ...
      <div class="auth-brand">
        ...
        <div class="brand-content">
          ...
          <div class="brand-text">
            ...
            <p>No worries, we'll send you reset instructions to get back into your account.</p>
          </div>
        ...
        <div class="auth-card">
          ...
          <div class="auth-card-body">
            ...
            <form method="post" class="auth-form" action="{{ route('password.email') }}">
              ...
              <div class="form-group">
                ...
                <div class="input-icon-wrap">
                  ...
                  <input type="email" class="form-control" name="email" id="email" autocomplete="email" value="{{ old('email') }}" placeholder="you@example.com" required>
                </div>
            ...
            <p class="auth-footer-note mt-3">
              Remember your password? <a href="{{ route('clientportallogin') }}">Sign in</a>
            </p>
          </div>
        </div>
...
.alert-success { display: flex; align-items: center; gap: 10px; background: rgba(16,185,129,.1); border: 1px solid rgba(16,185,129,.2); color: #059669; padding: 12px 16px; border-radius: 10px; font-size: .875rem; margin-bottom: 20px; }
...
.auth-footer-note a { color: var(--auth-primary); text-decoration: none; font-weight: 600; }
.auth-footer-note a:hover { text-decoration: underline; }
.auth-footer-note.mt-3 { margin-top: 16px; }
