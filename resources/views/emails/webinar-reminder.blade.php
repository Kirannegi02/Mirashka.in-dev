            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
               ...
               <tr>
                  <td style="padding:30px; color:#333333;">
                     <h2 style="margin-top:0; color:#006039;">Webinar Reminder</h2>
                     <p style="font-size:15px; line-height:1.6;">
                        Hello <strong>{{ $registration->name }}</strong>,
                     </p>
                     <p style="font-size:15px; line-height:1.6; color:#d9534f;">
                        Your webinar is starting soon! Don't miss it.
                     </p>
                      ...
                      <div style="background:#f0f8f5; border-left:4px solid #006039; padding:15px; margin:20px 0;">
                         ...
                         <p style="margin:15px 0 5px 0; text-align:center;">
                            <a href="{{ $webinar->meeting_link }}" style="background:#d9534f; color:#ffffff; padding:14px 28px; text-decoration:none; border-radius:6px; display:inline-block; font-weight:bold; font-size:16px;">Join Webinar Now</a>
                         </p>
                         @else
                         <p style="margin:15px 0 5px 0; font-size:13px; color:#d9534f; font-style:italic;">
                     ...
                     <p style="font-size:14px; color:#666;">
                        Make sure to join a few minutes early to ensure everything works properly.
                     </p>
