...
return [
    ...
    'risk' => [
        'before_title' => 'Operations Reality',
    ...
    'workplace_integrity' => [
        ...
        'float_cards' => [
            ...
            [
                ...
                'text' => 'Headcount, compliance status, open items and workforce insights for leadership.',
    ...
    'deliverables' => [
        ...
        'heading' => 'Payroll, documentation and operational clarity',
        'content' => 'Deliverables your finance, HR and leadership teams can rely on — not scattered files and last-minute firefighting.',
        'cards' => [
            [
                'style' => 'standard',
    ...
    'suitable_for' => [
        ...
        'heading' => 'Built for teams outgrowing informal HR',
        'segments' => [
            [
                'step' => '01',
                'label' => 'Startups',
                'icon' => 'ri-rocket-line',
                'text' => 'Establish payroll rhythm, policies and HR documentation before complexity compounds.',
            ],
            [
                'step' => '02',
                'label' => 'SMEs',
                'icon' => 'ri-building-2-line',
                'text' => 'Standardize HR operations as headcount and locations grow.',
            ],
            [
                'step' => '03',
                'label' => 'Franchises',
                'icon' => 'ri-store-2-line',
                'text' => 'Consistent payroll, policies and remote HR support across units.',
            ],
            [
                'step' => '04',
                'label' => 'Scaling Companies',
                'icon' => 'ri-line-chart-line',
                'text' => 'Process-driven HR that frees leadership to focus on revenue and strategy.',
            ],
        ],
    ],
    'cta' => [
