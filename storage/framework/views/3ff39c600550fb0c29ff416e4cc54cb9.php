        ...
        <div class="row g-4 align-items-start">
          <div class="col-lg-3 col-md-4">
            <div class="solutions-feature-card">
              <img src="<?php echo e(asset('assets/frontend/img/page/r-menu.jpeg')); ?>" alt="Employee Growth & Upskilling" class="solutions-feature-image" loading="lazy">
              ...
              <a href="<?php echo e(url('/partnerships-contact')); ?>" class="solutions-feature-btn">partnership opportunities</a>
            </div>
          </div>

          <div class="col-lg-5 col-md-8">
            <div class="solutions-links-list">
              <a href="<?php echo e(url('/for-hr-teams')); ?>"><span>For HR Teams</span><i class="ri-arrow-right-line"></i></a>
              <a href="<?php echo e(url('/for-small-businesses')); ?>"><span>For Small Businesses</span><i class="ri-arrow-right-line"></i></a>
              <a href="<?php echo e(url('/for-franchises')); ?>"><span>For Franchises</span><i class="ri-arrow-right-line"></i></a>
              <a href="<?php echo e(url('/for-startups')); ?>"><span>For Startups</span><i class="ri-arrow-right-line"></i></a>
            </div>

            <div class="solutions-media-grid">
              <img src="<?php echo e(asset('assets/frontend/img/page/r-menu.jpeg')); ?>" alt="Video 1" loading="lazy">
              ...
              <img src="<?php echo e(asset('assets/frontend/img/page/wwa-menu1.jpg')); ?>" alt="Video 3" loading="lazy">
            </div>
          </div>
          ...
          <div class="col-lg-4 solutions-divider">
            <div class="solutions-quote">
              ...
              <div class="solutions-author">
                <img src="<?php echo e(asset('assets/frontend/img/menu/Animesh-Singh-Chief-Talent-Architect.png')); ?>" alt="Animesh Singh" loading="lazy">
                <div>
                  <h6>Animesh Singh</h6>
...
<?php /**PATH F:\xampp\htdocs\Mirashka.in-dev\resources\views/frontend/layouts/common/megamenu/solutions.blade.php ENDPATH**/ ?>