...
<div class="whatwedo-pane active" data-whatwedo-pane="compliance-integrity" role="tabpanel">
  <div class="whatwedo-cards">
    <a href="<?php echo e(route('compliance.sub', 'expert-legal-hr-consultations')); ?>" class="whatwedo-card">
    ...
    <a href="<?php echo e(route('compliance.sub', 'policy-documentation-excellence')); ?>" class="whatwedo-card">
    ...
    <a href="<?php echo e(route('compliance.sub', 'compliance-risk-assessments')); ?>" class="whatwedo-card">
    ...
    <a href="<?php echo e(route('compliance.sub', 'workplace-ethics-training')); ?>" class="whatwedo-card">
...
<?php /**PATH F:\xampp\htdocs\Mirashka.in-dev\resources\views/frontend/layouts/common/megamenu/who-sections/compliance-integrity.blade.php ENDPATH**/ ?>