            ...
            <div class="row align-items-end">
               <div class="col-lg-8">
                  <div class="title_all_box style_one light_color">
                     <div class="title_sections">
                        <div class="before_title"><?php echo e($integrated['label'] ?? 'What We Do'); ?></div>
                        <h2><?php echo e($integrated['heading'] ?? 'Integrated HR & Workforce Services'); ?></h2>
                        <?php if(!empty($integrated['subheading'])): ?>
                           <p class="home-integrated-services__subheading"><?php echo e($integrated['subheading']); ?></p>
                        <?php endif; ?>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4">
                  <div class="theme_btn_all color_one text-md-end">
                     <a href="<?php echo e(route($integrated['cta_route'] ?? 'whatwedo')); ?>" class="theme-btn one"><?php echo e($integrated['cta'] ?? 'Explore All Services'); ?></a>
                     ...
                     <div class="swiper-slide">
                        <div class="service_carousel style_one">
                           <div class="image">
                              ...
                              <img src="<?php echo e(asset($service['image'])); ?>" alt="<?php echo e($service['title']); ?>" width="279" height="400" loading="lazy">
                           </div>
                           <div class="content">
                              <div class="icon_box">
                                 <span><i class="<?php echo e($service['icon']); ?>" aria-hidden="true"></i></span>
                              </div>
                              <h2 class="title_service"><a href="<?php echo e($href); ?>"><?php echo e($service['title']); ?></a></h2>
                              <p class="text-white"><?php echo e($service['subtitle']); ?></p>
                           </div>
                        </div>
                     </div>
...
<?php /**PATH F:\xampp\htdocs\Mirashka.in-dev\resources\views/frontend/pages/home-sections/integrated-hr-services.blade.php ENDPATH**/ ?>