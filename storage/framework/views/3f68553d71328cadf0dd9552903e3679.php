...
<div class="whatwedo-pane" data-whatwedo-pane="workforce-efficiency" role="tabpanel" aria-hidden="true">
  <div class="whatwedo-service-cards">
    <a href="<?php echo e(route('workforce.sub', 'policy-design-compliance-audit')); ?>" class="whatwedo-service-card">
    ...
    <a href="<?php echo e(route('workforce.sub', 'payroll-outsourcing-administration')); ?>" class="whatwedo-service-card">
      <div class="whatwedo-service-head">
    ...
    <a href="<?php echo e(route('workforce.sub', 'remote-hr-solutions')); ?>" class="whatwedo-service-card">
      <div class="whatwedo-service-head">
...
<?php /**PATH F:\xampp\htdocs\Mirashka.in-dev\resources\views/frontend/layouts/common/megamenu/who-sections/workforce-efficiency.blade.php ENDPATH**/ ?>