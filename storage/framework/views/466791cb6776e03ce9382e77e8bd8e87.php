...
<div class="whatwedo-pane" data-whatwedo-pane="hiring-excellence" role="tabpanel" aria-hidden="true">
  <div class="whatwedo-hiring-layout">
    <div class="whatwedo-hiring-services">
      <a href="<?php echo e(route('talent-acquisition.sub', 'it-staffing')); ?>" class="whatwedo-hiring-card">
      ...
      <a href="<?php echo e(route('talent-acquisition.sub', 'general-staffing')); ?>" class="whatwedo-hiring-card">
      ...
      <a href="<?php echo e(route('talent-acquisition.sub', 'naps-apprenticeship-support')); ?>" class="whatwedo-hiring-card">
      ...
      <a href="<?php echo e(route('talent-acquisition.sub', 'it-recruitment')); ?>" class="whatwedo-hiring-card">
      ...
      <a href="<?php echo e(route('talent-acquisition.sub', 'recruitment-process-outsourcing')); ?>" class="whatwedo-hiring-card">
      ...
      <a href="<?php echo e(route('talent-acquisition.sub', 'executive-search')); ?>" class="whatwedo-hiring-card">
...
<?php /**PATH F:\xampp\htdocs\Mirashka.in-dev\resources\views/frontend/layouts/common/megamenu/who-sections/hiring-excellence.blade.php ENDPATH**/ ?>