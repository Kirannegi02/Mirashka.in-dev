    ...
    <div class="row g-2 px-2 py-2">
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="icon_box_all style_one hover-effect">
          ...
          <div class="txt_content">
            <h3><a href="<?php echo e(route('projectenquiries')); ?>">General Inquiries</a></h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="icon_box_all style_one hover-effect">
          ...
          <div class="txt_content">
            <h3><a href="<?php echo e(route('mediapresscontact')); ?>">Service Requests</a></h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="icon_box_all style_one hover-effect">
          ...
          <div class="txt_content">
            <h3><a href="<?php echo e(route('partnershipscontact')); ?>">Partnership Opportunities</a></h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="icon_box_all style_one hover-effect">
          ...
          <div class="txt_content">
            <h3><a href="<?php echo e(route('officelocations')); ?>">Office Locations</a></h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="icon_box_all style_one hover-effect">
          ...
          <div class="txt_content">
            <h3><a href="<?php echo e(route('clientportallogin')); ?>">Regional Contacts</a></h3>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="extra_content image_with_content dark_color mt-4 mr-2">
          <div class="simple_image">
            <img src="<?php echo e(asset('assets/frontend/img/india.png')); ?>" alt="img">
...
</style><?php /**PATH F:\xampp\htdocs\Mirashka.in-dev\resources\views/frontend/layouts/common/megamenu/contact.blade.php ENDPATH**/ ?>