        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="section-header-one">
                    <h2 class="section-title"><?php echo $finalCta['heading'] ?? 'You are one step closer to building<br> your next growth chapter'; ?></h2>
                    <div class="middle mt-2"></div>
                    <p>
                        <?php echo e($finalCta['intro'] ?? 'Share your goals and project requirements with Mirashka. Our team will review your brief and connect with a practical strategy across brand, technology, and performance marketing.'); ?>
                ...
                <div class="card pricing-card pricing-card-active rounded-10 doc-plan-rise w-100 h-100">
                    <div class="card-body">
                        <div class="pricing-header">
                            <img src="<?php echo e(asset($finalCta['sidebar_image'] ?? 'assets/frontend/img/page/contact.jpg')); ?>" alt="<?php echo e($finalCta['sidebar_image_alt'] ?? 'What is included'); ?>" class="doc-plan-card-img">
                        </div>
                        <div class="pricing-info">
                            <h2 class="text-white"><?php echo e($finalCta['sidebar_title'] ?? 'What you get'); ?></h2>
                            <hr class="doc-plan-card-divider">
                            <p class="text-white mb-0">
                                <?php echo e($finalCta['sidebar_text'] ?? 'Discovery call, execution roadmap, and transparent next steps tailored to your business goals, team structure, timeline, and expected outcomes.'); ?>
            ...
            <div class="col-lg-8 col-md-12 d-flex">
                <div class="card contact-form-card rounded-10 doc-plan-rise w-100 h-100">
                    <div class="card-body d-flex flex-column pt-3 pb-3 px-3">
                        <form id="project-enquiry-form" class="contactForm cm-doc-plan-form d-flex flex-column" method="post" action="<?php echo e(route('contact.submit')); ?>" role="form" autocomplete="on">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row gx-3 gy-0 doc-plan-field-row">
                                ...
                                <div class="col-md-6">
                                    <div class="doc-plan-field">
                                        <label class="doc-plan-label mb-2" for="project-enquiry-project"><?php echo e($finalCta['form_project_label'] ?? 'Project Name'); ?> <span class="text-danger">*</span></label>
                                        <input type="text" id="project-enquiry-project" class="form-control form-control-sm" name="project_name" placeholder="<?php echo e($finalCta['form_project_placeholder'] ?? 'Enter project name'); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="doc-plan-field">
                                        <label class="doc-plan-label mb-2" for="project-enquiry-details"><?php echo e($finalCta['form_details_label'] ?? 'Project Details'); ?> <span class="text-danger">*</span></label>
                                        <textarea class="form-control form-control-sm doc-plan-textarea" id="project-enquiry-details" rows="2" name="project_details" placeholder="<?php echo e($finalCta['form_details_placeholder'] ?? 'Describe your project...'); ?>" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group-btn mb-0 pt-1">
                                <button type="submit" class="btn btn-primary prime-btn submitBtn" id="project-enquiry-submit"><?php echo e($finalCta['submit_label'] ?? 'Submit Enquiry'); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row align-items-end mx-0">
                <div class="col-lg-7 col-md-12 px-2">
                    <div class="section-inner-header way-inner-header mb-0 py-2">
                        <h2><?php echo e($finalCta['way_heading'] ?? 'Take the first step towards accelerating your brand and business'); ?></h2>
                        <p><?php echo e($finalCta['way_text'] ?? 'Get strategic clarity and expert execution tailored for your growth journey. Start today for stronger outcomes and scalable momentum'); ?></p>
                        <a href="<?php echo e(url($finalCta['way_button_url'] ?? '/project-enquiries')); ?>" class="btn btn-primary theme-btn one"><?php echo e($finalCta['way_button'] ?? 'Contact Us'); ?></a>
                    </div>
                </div>

                <div class="col-lg-5 col-md-12 px-2">
                    <div class="way-img">
                        <img src="<?php echo e(asset($finalCta['way_image'] ?? 'assets/frontend/img/page/contactUs.png')); ?>" class="img-fluid" alt="<?php echo e($finalCta['way_image_alt'] ?? 'Contact Mirashka HR'); ?>">
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH F:\xampp\htdocs\Mirashka.in-dev\resources\views/frontend/layouts/common/footer-cta.blade.php ENDPATH**/ ?>